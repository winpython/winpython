...
[astroid](https://pypi.org/project/astroid) | 2.6.6 | An abstract syntax tree for Python with inference support.
...
[dask_ml](https://pypi.org/project/dask_ml) | 2021.10.17 | A library for distributed and parallel machine learning
...
[fastai](https://pypi.org/project/fastai) | 2.5.3 | fastai makes deep learning with PyTorch faster, more accurate, and easier
...
[fastparquet](https://pypi.org/project/fastparquet) | 0.7.1 | Python support for Parquet file format
...
[flake8](https://pypi.org/project/flake8) | 3.9.2 | the modular source code checker: pep8, pyflakes and co
...
[guiqwt](https://pypi.org/project/guiqwt) | 3.0.7 | guiqwt is a set of tools for curve and image plotting (extension to PythonQwt)
...
[llvmlite](https://pypi.org/project/llvmlite) | 0.37.0 | lightweight wrapper around basic LLVM functionality
...
[matplotlib](https://pypi.org/project/matplotlib) | 3.5.0.dev2464+g95463c32e6 | Python plotting package
...
[mysql_connector_python](https://pypi.org/project/mysql_connector_python) | 8.0.26 | MySQL driver written in Python
...
[numba](https://pypi.org/project/numba) | 0.54.1 | compiling Python code using LLVM
...
[numpy](https://pypi.org/project/numpy) | 1.20.3+mkl | NumPy is the fundamental package for array computing with Python.
...
[onnxruntime](https://pypi.org/project/onnxruntime) | 1.9.0 | ONNX Runtime Python bindings
...
[pyarrow](https://pypi.org/project/pyarrow) | 6.0.0 | Python library for Apache Arrow
...
[pylint](https://pypi.org/project/pylint) | 2.9.6 | python code static checker
...
[pythonqwt](https://pypi.org/project/pythonqwt) | 0.9.2 | Qt plotting widgets for Python
...
[qtawesome](https://pypi.org/project/qtawesome) | 1.1.0 | FontAwesome icons in PyQt and PySide applications
...
[quantecon](https://pypi.org/project/quantecon) | 0.5.1 | QuantEcon is a package to support all forms of quantitative economic modelling.
...
[rope](https://pypi.org/project/rope) | 0.21.0 | a python refactoring library...
...
[spyder](https://pypi.org/project/spyder) | 5.1.5 | The Scientific Python Development Environment
[spyder_kernels](https://pypi.org/project/spyder_kernels) | 2.1.3 | Jupyter kernels for Spyder's console
...
[torch](https://pypi.org/project/torch) | 1.10.0 | Tensors and Dynamic neural networks in Python with strong GPU acceleration
[torchaudio](https://pypi.org/project/torchaudio) | 0.10.0 | An audio package for PyTorch
[torchvision](https://pypi.org/project/torchvision) | 0.11.1 | image and video datasets and models for torch deep learning
...
[xlsxwriter](https://pypi.org/project/xlsxwriter) | 3.0.2 | A Python module for creating Excel XLSX files.
...
[zstandard](https://pypi.org/project/zstandard) | 0.16.0 | Zstandard bindings for Python