...
The following packages are included in WinPython-64bit v3.8.7.0 .
...
[llvmlite](https://pypi.org/project/llvmlite) | 0.35.0 | lightweight wrapper around basic LLVM functionality
...
[numba](https://pypi.org/project/numba) | 0.52.0 | compiling Python code using LLVM
...
[reportlab](https://pypi.org/project/reportlab) | 3.5.56 | The Reportlab Toolkit
...
[torch](https://pypi.org/project/torch) | 1.7.1+cpu | Tensors and Dynamic neural networks in Python with strong GPU acceleration
[torchvision](https://pypi.org/project/torchvision) | 0.8.2+cpu | image and video datasets and models for torch deep learning
...
[wasmer](https://pypi.org/project/wasmer) | 1.0.0b1 | Python extension to run WebAssembly binaries
