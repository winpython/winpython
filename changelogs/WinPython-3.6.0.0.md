...
The following packages are included in WinPython v3.6.0.0 .
...
[jupyterlab](http://pypi.python.org/pypi/jupyterlab) | 0.8.0 | Jupyter lab environment notebook server extension
...
[msgpack-python](http://pypi.python.org/pypi/msgpack-python) | 0.4.8 | MessagePack (de)serializer.
...
[pyzmq](http://pypi.python.org/pypi/pyzmq) | 16.0.0 | Lightweight and super-fast messaging based on ZeroMQ library (required for IPython Qt console)
