## WinPython 3.8.12.2PyPy 

The following packages are included in WinPython-64bit v3.8.12.2PyPy .
...
[importlib_resources](https://pypi.org/project/importlib_resources) | 5.7.1 | Read resources from Python packages
...
[jupyterlab](https://pypi.org/project/jupyterlab) | 3.3.4 | The JupyterLab notebook server extension.
...
[nbclient](https://pypi.org/project/nbclient) | 0.6.0 | A client library for executing notebooks. Formally nbconvert's ExecutePreprocessor.
...
[numpy](https://pypi.org/project/numpy) | 1.22.3+mkl | NumPy is the fundamental package for array computing with Python.
...
[pydantic](https://pypi.org/project/pydantic) | 1.9.0 | Data validation and settings management using python 3.6 type hinting
