...
The following packages are included in WinPython-64bit v3.11.5.0 .
...
[confection](https://pypi.org/project/confection) | 0.1.1 | The sweetest config system for Python
...
[numexpr](https://pypi.org/project/numexpr) | 2.8.6 | Fast numerical expression evaluator for NumPy
[numpy](https://pypi.org/project/numpy) | 1.25.2 | NumPy is the fundamental package for array computing with Python.
