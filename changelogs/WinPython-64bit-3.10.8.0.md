...
[black](https://pypi.org/project/black) | 22.10.0 | The uncompromising code formatter.
...
[dash](https://pypi.org/project/dash) | 2.6.2 | A Python framework for building reactive web-apps. Developed by Plotly.
...
[dask](https://pypi.org/project/dask) | 2022.10.1 | Parallel PyData with Task Scheduling
...
[datasette](https://pypi.org/project/datasette) | 0.62 | A tool for exploring and publishing data
...
[distributed](https://pypi.org/project/distributed) | 2022.10.1 | Distributed scheduler for Dask
...
[fastapi](https://pypi.org/project/fastapi) | 0.85.1 | FastAPI framework, high performance, easy to learn, fast to code, ready for production
...
[fastparquet](https://pypi.org/project/fastparquet) | 0.8.3 | Python support for Parquet file format
...
[guidata](https://pypi.org/project/guidata) | 2.3.0 | Automatic graphical user interfaces generation for easy dataset editing and display
...
[holoviews](https://pypi.org/project/holoviews) | 1.15.1 | Stop plotting your data - annotate your data and let it visualize itself.
...
[hvplot](https://pypi.org/project/hvplot) | 0.8.1 | A high-level plotting API for the PyData ecosystem built on HoloViews.
...
[ipykernel](https://pypi.org/project/ipykernel) | 6.16.2 | IPython Kernel for Jupyter
...
[ipywidgets](https://pypi.org/project/ipywidgets) | 8.0.2 | IPython HTML widgets for Jupyter
...
[jupyter_core](https://pypi.org/project/jupyter_core) | 4.11.2 | Jupyter core package. A base package on which Jupyter projects rely.
...
[jupyter_server](https://pypi.org/project/jupyter_server) | 1.21.0 | The Jupyter Server
...
[jupyterlab](https://pypi.org/project/jupyterlab) | 3.5.0 | The JupyterLab notebook server extension.
...
[jupyterlab_server](https://pypi.org/project/jupyterlab_server) | 2.16.1 | JupyterLab Server
[jupyterlab_widgets](https://pypi.org/project/jupyterlab_widgets) | 3.0.3 | JupyterLab extension providing HTML widgets
...
[matplotlib](https://pypi.org/project/matplotlib) | 3.6.0 | Python plotting package
...
[mypy](https://pypi.org/project/mypy) | 0.982 | Optional static typing for Python
...
[nbclassic](https://pypi.org/project/nbclassic) | 0.4.7 | Jupyter Notebook as a Jupyter Server Extension.
...
[networkx](https://pypi.org/project/networkx) | 2.8.7 | Python package for creating and manipulating graphs and networks
...
[numba](https://pypi.org/project/numba) | 0.56.3 | compiling Python code using LLVM
...
[numpy](https://pypi.org/project/numpy) | 1.23.4 | NumPy is the fundamental package for array computing with Python.
...
[pandas](https://pypi.org/project/pandas) | 1.5.1 | Powerful data structures for data analysis, time series, and statistics
...
[panel](https://pypi.org/project/panel) | 0.14.1 | A high level app and dashboarding solution for Python.
...
[polars](https://pypi.org/project/polars) | 0.14.22 | Blazingly fast DataFrame library
...
[protobuf](https://pypi.org/project/protobuf) | 4.21.9 | Protocol Buffers
...
[pyarrow](https://pypi.org/project/pyarrow) | 9.0.0 | Python library for Apache Arrow
...
[python_lsp_server](https://pypi.org/project/python_lsp_server) | 1.5.0 | Python Language Server for the Language Server Protocol
...
[pytoolconfig](https://pypi.org/project/pytoolconfig) | 1.2.1 | Python tool configuration
...
[pywin32](https://pypi.org/project/pywin32) | 304.0 | Python for Window Extensions
...
[qtconsole](https://pypi.org/project/qtconsole) | 5.3.2 | Jupyter Qt console
[qtpy](https://pypi.org/project/qtpy) | 2.2.1 | Provides an abstraction layer on top of the various Qt bindings (PyQt5, PyQt4 and PySide) and additional custom QWidgets.
...
[seaborn](https://pypi.org/project/seaborn) | 0.12.1 | seaborn: statistical data visualization
...
[spyder](https://pypi.org/project/spyder) | 5.3.3 | The Scientific Python Development Environment
[spyder_kernels](https://pypi.org/project/spyder_kernels) | 2.3.3 | Jupyter kernels for Spyder's console
...
[sqlite_utils](https://pypi.org/project/sqlite_utils) | 3.29 | CLI tool and Python utility functions for manipulating SQLite databases
...
[starlette](https://pypi.org/project/starlette) | 0.20.4 | The little ASGI library that shines.
...
[torch](https://pypi.org/project/torch) | 1.12.1 | Tensors and Dynamic neural networks in Python with strong GPU acceleration
[torchaudio](https://pypi.org/project/torchaudio) | 0.12.1 | An audio package for PyTorch
[torchvision](https://pypi.org/project/torchvision) | 0.13.1 | image and video datasets and models for torch deep learning
...
[traitlets](https://pypi.org/project/traitlets) | 5.4.0 | Traitlets Python config system
...
[tzdata](https://pypi.org/project/tzdata) | 2022.5 | Provider of IANA time zone data
...
[uvicorn](https://pypi.org/project/uvicorn) | 0.19.0 | The lightning-fast ASGI server.
...
[websocket_client](https://pypi.org/project/websocket_client) | 1.4.1 | WebSocket client for Python. hybi13 is supported.
...
[widgetsnbextension](https://pypi.org/project/widgetsnbextension) | 4.0.3 | IPython HTML widgets for Jupyter
...
[xarray](https://pypi.org/project/xarray) | 2022.10.0 | N-D labeled arrays and datasets in Python
