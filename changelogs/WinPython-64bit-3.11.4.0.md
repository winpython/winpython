...
The following packages are included in WinPython-64bit v3.11.4.0 .
...
[accelerate](https://pypi.org/project/accelerate) | 0.20.3 | Accelerate
...
[altair](https://pypi.org/project/altair) | 5.0.1 | Altair: A declarative statistical visualization library for Python.
...
[cython](https://pypi.org/project/cython) | 0.29.35 | The Cython compiler for writing C extensions for the Python language.
[cytoolz](https://pypi.org/project/cytoolz) | 0.12.1 | Cython implementation of Toolz: High performance functional utilities
[dash](https://pypi.org/project/dash) | 2.9.3 | A Python framework for building reactive web-apps. Developed by Plotly.
...
[dask](https://pypi.org/project/dask) | 2023.6.0 | Parallel PyData with Task Scheduling
...
[datashader](https://pypi.org/project/datashader) | 0.15.1 | Data visualization toolchain based on aggregating into a grid
...
[distributed](https://pypi.org/project/distributed) | 2023.6.0 | Distributed scheduler for Dask
...
[holoviews](https://pypi.org/project/holoviews) | 1.16.1 | Stop plotting your data - annotate your data and let it visualize itself.
...
[ipykernel](https://pypi.org/project/ipykernel) | 6.23.1 | IPython Kernel for Jupyter
...
[jupyterlab](https://pypi.org/project/jupyterlab) | 3.6.5 | The JupyterLab notebook server extension.
...
[llvmlite](https://pypi.org/project/llvmlite) | 0.40.1 | lightweight wrapper around basic LLVM functionality
...
[matplotlib](https://pypi.org/project/matplotlib) | 3.7.2 | Python plotting package
...
[numba](https://pypi.org/project/numba) | 0.57.1 | compiling Python code using LLVM
...
[openai](https://pypi.org/project/openai) | 0.27.7 | Python client library for the OpenAI API
...
[pandas](https://pypi.org/project/pandas) | 2.0.2 | Powerful data structures for data analysis, time series, and statistics
...
[panel](https://pypi.org/project/panel) | 1.0.4 | A high level app and dashboarding solution for Python.
...
[plotly](https://pypi.org/project/plotly) | 5.14.1 | An open-source, interactive graphing library for Python
...
[polars](https://pypi.org/project/polars) | 0.18.4 | Blazingly fast DataFrame library
...
[rich](https://pypi.org/project/rich) | 13.3.5 | Render rich text, tables, progress bars, syntax highlighting, markdown and more to the terminal
...
[sqlalchemy](https://pypi.org/project/sqlalchemy) | 2.0.15 | Database Abstraction Library
...
[trio](https://pypi.org/project/trio) | 0.22.1 | A friendly Python library for async concurrency and I/O
...
[websocket_client](https://pypi.org/project/websocket_client) | 1.5.1 | WebSocket client for Python. hybi13 is supported.
[werkzeug](https://pypi.org/project/werkzeug) | 2.3.4 | The comprehensive WSGI web application library.
...
[xarray](https://pypi.org/project/xarray) | 2023.5.0 | N-D labeled arrays and datasets in Python
...
[xlsxwriter](https://pypi.org/project/xlsxwriter) | 3.1.0 | A Python module for creating Excel XLSX files.
