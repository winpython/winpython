...
The following packages are included in WinPython-64bit v3.8.9.0 .
...
[gpytorch](https://pypi.org/project/gpytorch) | 1.4.0 | An implementation of Gaussian Processes in Pytorch
...
[pytest](https://pypi.org/project/pytest) | 6.2.3 | pytest: simple powerful testing with Python
...
[torch](https://pypi.org/project/torch) | 1.8.1+cpu | Tensors and Dynamic neural networks in Python with strong GPU acceleration
[torchaudio](https://pypi.org/project/torchaudio) | 0.8.1 | An audio package for PyTorch
[torchvision](https://pypi.org/project/torchvision) | 0.9.1+cpu | image and video datasets and models for torch deep learning
