...
The following packages are included in WinPython v3.5.1.2 .
...
[astroid](http://pypi.python.org/pypi/astroid) | 1.4.4 | Rebuild a new abstract syntax tree from Python's ast (required for pylint)
...
[bqplot](http://pypi.python.org/pypi/bqplot) | 0.5.1 | Interactive plotting for the Jupyter notebook, using d3.js and ipywidgets.
...
[cffi](http://pypi.python.org/pypi/cffi) | 1.5.0 | Foreign Function Interface for Python calling C code.
...
[colorama](http://pypi.python.org/pypi/colorama) | 0.3.5 | Cross-platform colored terminal text
...
[dask](http://pypi.python.org/pypi/dask) | 0.7.6 | Minimal task scheduling abstraction
[datashape](http://pypi.python.org/pypi/datashape) | 0.5.1 | A data description language
...
[holoviews](http://pypi.python.org/pypi/holoviews) | 1.4.1 | Composable, declarative data structures for building complex visualizations easily.
...
[ipykernel](http://pypi.python.org/pypi/ipykernel) | 4.2.2 | IPython Kernel for Jupyter
[ipyparallel](http://pypi.python.org/pypi/ipyparallel) | 5.0.0 | Interactive Parallel Computing with IPython
[ipython](http://pypi.python.org/pypi/ipython) | 4.1.1 | Enhanced Python shell
...
[jupyter-console](http://pypi.python.org/pypi/jupyter-console) | 4.1.0 | Jupyter metapackage. Install all the Jupyter components in one go.
...
[keras](http://pypi.python.org/pypi/keras) | 0.3.1 | Theano-based Deep Learning library
...
[netcdf4](http://pypi.python.org/pypi/netcdf4) | 1.2.2 | python/numpy interface to netCDF library (versions 3 and 4)
...
[numba](http://pypi.python.org/pypi/numba) | 0.23.1 | compiling Python code using LLVM
...
[oct2py](http://pypi.python.org/pypi/oct2py) | 3.4.0 | Python to GNU Octave bridge --> run m-files from python.
[odo](http://pypi.python.org/pypi/odo) | 0.4.1 | Data migration in Python
...
[pillow](http://pypi.python.org/pypi/pillow) | 3.1.1 | Python Imaging Library (fork)
...
[prompt-toolkit](http://pypi.python.org/pypi/prompt-toolkit) | 0.57 | Library for building powerful interactive command lines in Python
[psutil](http://code.google.com/p/psutil) | 3.4.2 | Provides an interface for retrieving information on all running processes and system utilization (CPU, disk, memory, network) in a portable way
...
[pygments](http://pygments.org) | 2.1 | Generic syntax highlighter for general use in all kinds of software
[pylint](http://www.logilab.org/project/pylint) | 1.5.4 | Logilab code analysis module: analyzes Python source code looking for bugs and signs of poor quality
...
[pymongo](http://pypi.python.org/pypi/pymongo) | 3.2 | Python driver for MongoDB <http://www.mongodb.org>
...
[pyparsing](http://pyparsing.wikispaces.com/) | 2.0.7 | A Python Parsing Module
...
[pytest](http://pypi.python.org/pypi/pytest) | 2.8.5 | pytest: simple powerful testing with Python
...
[qtpy](http://pypi.python.org/pypi/qtpy) | 0.1.3 | Provides an abstraction layer on top of the various Qt bindings (PyQt5, PyQt4 and PySide) and additional custom QWidgets.
...
[requests-toolbelt](http://pypi.python.org/pypi/requests-toolbelt) | 0.5.1 | Requests is an Apache2 Licensed HTTP library, written in Python, for human beings.
...
[sphinx](http://pypi.python.org/pypi/sphinx) | 1.3.5 | Tool for generating documentation which uses reStructuredText as its markup language
...
[sqlalchemy](http://www.sqlalchemy.org) | 1.0.11 | SQL Toolkit and Object Relational Mapper
...
[traitlets](http://pypi.python.org/pypi/traitlets) | 4.1.0 | Traitlets Python config system
...
[werkzeug](http://pypi.python.org/pypi/werkzeug) | 0.11.3 | The Swiss Army knife of Python web development
...
[wrapt](http://pypi.python.org/pypi/wrapt) | 1.10.6 | A Python module for decorators, wrappers and monkey patching.
