...
set my_root_dir_for_builds=D:\WinpythonQt5
...
rem set my_find_links=D:\WinPython\basedir34\packages.srcreq
...
set my_source_dirs=D:\WinPython\basedir34\packages.src D:\WinPython\basedir34\packages.win-32.Qt5
set my_toolsdirs=
